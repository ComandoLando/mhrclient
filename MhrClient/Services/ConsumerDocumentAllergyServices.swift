...
public class ConsumerDocumentAllergyServices: ServiceBase, ConsumerDocumentAllergyServicesProtocol {
    ...
    public func getAllergys(patientId: String, successCallback: @escaping (SwiftFHIR.Bundle?) -> Void, failureCallback: @escaping (MhrError?) -> Void) {
    }
    ...
    public func createAllergy(allergyIntolerance: SwiftFHIR.AllergyIntolerance, docId: String, successCallback: @escaping (SwiftFHIR.AllergyIntolerance?) -> Void, failureCallback: @escaping (MhrError?) -> Void) {
    }
    ...
    public func updateAllergy(allergyIntolerance: SwiftFHIR.AllergyIntolerance, docId: String, successCallback: @escaping (SwiftFHIR.AllergyIntolerance?) -> Void, failureCallback: @escaping (MhrError?) -> Void) {
    }
