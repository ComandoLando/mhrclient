...
public protocol ConsumerDocumentAllergyServicesProtocol {
    ...
    // Get allergies
    func getAllergy(patientId: String, successCallback: @escaping (SwiftFHIR.Bundle?) -> Void, failureCallback: @escaping (MhrError?) -> Void)
    ...
    func createAllergy(allergyIntolerance: SwiftFHIR.Bundle, docId: String, successCallback: @escaping (SwiftFHIR.Bundle?) -> Void, failureCallback: @escaping (MhrError?) -> Void)
    ...
    func updateAllergy(allergyIntolerance: SwiftFHIR.Bundle, docId: String, successCallback: @escaping (SwiftFHIR.Bundle?) -> Void, failureCallback: @escaping (MhrError?) -> Void)
